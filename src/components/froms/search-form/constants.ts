...
const controlStyles = {
    base: " text-black border-2 outline-none border-friar-gray font-sans rounded-3xl bg-white hover:cursor-pointer h-[52px] w-32",
...
const optionStyles = {
    ...
    selected: "text-black font-semibold after:content-['✔'] after:ml-2 after:text-green-500 ",
};
const noOptionsMessageStyles = " p-2 bg-gray-50 border border-dashed border-gray-200 rounded-sm";
